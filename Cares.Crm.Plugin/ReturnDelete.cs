...
namespace Cares.Crm.Plugin
{
    ...
    /// ReturnDelete Plugin.
    /// </summary>
    public class ReturnDelete : PluginBase
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReturnDelete"/> class.
        /// </summary>
        /// <param name="unsecure">Contains public (unsecured) configuration information.</param>
        /// <param name="secure">Contains non-public (secured) configuration information. 
        /// When using Microsoft Dynamics 365 for Outlook with Offline Access, 
        /// the secure string is not passed to a plug-in that executes while the client is offline.</param>
        public ReturnDelete(string unsecure, string secure)
            : base(typeof(ReturnDelete))
        {
        ...
        protected override void ExecuteCrmPlugin(LocalPluginContext localContext)
        {
            ...
            trace.Trace("[INFO] ReturnDelete Plugin Starts...");
            ...
            try
            {
                ...
                {
                    trace.Trace("[INFO] PreValidation of  Deletion of Return record - STARTED...");
                    ...
                    if (recordBefore.Attributes.Contains("statecode"))
                    {
                        ...
                        {
                            trace.Trace("[INFO] Return record in Inactive status cannot be deleted. Throwing business exception...");
                            throw new InvalidPluginExecutionException("Return record in Inactive status cannot be deleted");
                        }
                    }
                    else
                    {
                        throw new InvalidPluginExecutionException("[ERROR] Status (statecode) field is not registered in the PreImage of the ReturnDelete's PreValidation step.");
                    }
                    trace.Trace("[INFO] PreValidation of Deletion of Return record - COMPLETED.");
                }
            }
